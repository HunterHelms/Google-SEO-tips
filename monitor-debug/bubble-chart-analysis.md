...
Analyzing Search performance data is always a challenge, but even more so when you have plenty of
 long-tail queries, which are harder to visualize and understand. A [bubble chart](https://support.google.com/datastudio/answer/7207785) can help you understand which queries are performing well for your site, and which could be improved.
...
If you haven't read [connecting Search Console to Looker Studio](https://developers.google.com/search/blog/2022/03/connecting-data-studio) and [monitoring Search traffic with Looker Studio](https://developers.google.com/search/blog/2022/03/monitoring-dashboard),
...
A bubble chart is a great visualization when you have multiple metrics and dimensions because it
 ...
 data more effectively. In the example shown here, you can see [click-through rate](https://support.google.com/webmasters/answer/7576553#choosingmetrics) (CTR), average position, and clicks for the query and device dimensions in one view.
...
The bubble chart shown in this page uses the Site Impression table available through the [Search Console data source](https://support.google.com/datastudio/answer/7314895),
 which includes [Search performance data](https://support.google.com/webmasters/answer/7576553) aggregated by site and queries.

### Filters and data controls

There are five customization options in the chart to help you control your data effectively:

1. **[Data control](https://support.google.com/datastudio/answer/7415591)** :
 Choose the Search Console property you'd like to analyze.
2. **Date range** : Choose the date range you'd like to see in the report; by default you'll see
 the last 28 days.
...
1. **Reverse y-axis direction** : Since the y-axis shows average position,
...
2. **Log scale** : Using a [logarithmic scale](https://en.wikipedia.org/wiki/Logarithmic_scale) for both axes lets you to have a better understanding of queries that are in the extremities of
 the chart (very low CTR, average position, or both).
3. **[Reference lines](https://support.google.com/datastudio/answer/9921462)** :
...
1. **Top position, high CTR** : There's not much you need to do for those; you're doing a
 great job already.
2. **Low position, high CTR** : Those queries seem relevant to users; the queries get a high CTR
...
3. **Low position, low CTR** : When looking at queries with low CTR (both with low and top
...
4. **Top position, low CTR** : Those queries might have a low CTR for various reasons. Check the
 largest bubbles to find signs of the following:
  - Your competitors may have [structured data markup](https://developers.google.com/search/docs/appearance/search-result-features) and are showing up with rich results, which might attract users to click their results instead of
 yours. Consider optimizing for the most common [visual elements in Google Search](https://developers.google.com/search/docs/appearance/visual-elements-gallery) .
...
After you find the queries using the visualization shown in this page, you can [create a query filter](https://support.google.com/webmasters/answer/7576553#filteringdata) for specific queries using the Search Console user interface, or create a [pivot table](https://support.google.com/looker-studio/answer/7516660) using Looker Studio; in both ways, you can check all the pages that are receiving
 traffic for a specific query. After you know the queries you want to optimize and their related
 URLs, use the [SEO starter guide](https://developers.google.com/search/docs/fundamentals/seo-starter-guide) to optimize your content. Here are some tips:

- Ensure that your [title](https://developers.google.com/search/docs/appearance/title-link#page-titles) elements, [description meta tags](https://developers.google.com/search/docs/appearance/snippet#meta-descriptions) , and alt
...
- Think about other words that a user might search for to find a piece of your content, for
 ...
 use the [Keyword Planner](https://ads.google.com/home/tools/keyword-planner/) provided by Google Ads to help you discover new keyword variations and see the approximate search
 volume for each keyword. You can also [use Google Trends](https://developers.google.com/search/docs/monitor-debug/google-trends) to find ideas

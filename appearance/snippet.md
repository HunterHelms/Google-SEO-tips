...
A *snippet* is the description or summary part of search result on Google Search and
 ...
 automatically determine the appropriate snippet. We may also use descriptive information in the meta description element when it describes the page better than
...
While we can't manually change snippets for individual sites, we're always working
 ...
 displayed for your pages by following the best practices for creating quality meta descriptions.
...
Snippets are primarily created from the page content itself. However, Google sometimes uses the meta description HTML element if it might give users a more
...
You can prevent snippets from being created and shown for your site in
 ...
 To prevent Google from displaying a snippet for your page in search results, use the [`nosnippet` meta
 ...
 the page from being shown in a snippet by using the [`data-nosnippet`](https://developers.google.com/search/docs/crawling-indexing/special-tags#data-nosnippet) attribute.
...
>
> Written by A.N. Author, Illustrated by V. Gogh,
...
> <meta name="description" content="
>
> Sewing supplies, yarn, colored pencils, sewing
...
> <meta name="description" content="
>
> Get everything you need to sew your next
...
> <meta name="description" content="
>
> Local news in Whoville, delivered to your
...
> <meta name="description" content="
>
> Upsetting the small town of Whoville, a local
...
> <meta name="description" content="
>
> Eggs are a source of joy in everyone's life.
...
> <meta name="description" content="
>
> Learn how to cook eggs with this complete
...
> <meta name="description" content="
>
> Self-sharpening mechanical pencil that
...
- If you make [history API](https://developer.mozilla.org/en-US/docs/Web/API/History/pushState) calls or [window.location.hash](https://developer.mozilla.org/en-US/docs/Web/API/Location/hash) modifications on page load, make sure you don't remove the hash fragment from the URL, as this

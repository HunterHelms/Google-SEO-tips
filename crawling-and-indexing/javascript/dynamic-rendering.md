...
>
> [server-side rendering](https://web.dev/articles/rendering-on-the-web#server-side)
>
> ,
>
...
>  or
>
> [hydration](https://web.dev/articles/rendering-on-the-web#rehydration)
>
> as a solution.
...
Dynamic rendering was a workaround for indexable, public JavaScript-generated content that changes rapidly, or
 content that uses [JavaScript features that aren't supported by the crawlers](https://developers.google.com/search/docs/guides/rendering) you care about. Not all sites need to use dynamic rendering, and there are better solutions than dynamic rendering as explained in [an overview of rendering on the web](https://web.dev/articles/rendering-on-the-web).
...
![A diagram that shows how dynamic rendering works. The diagram shows the server serving
 ...
 renderer serves static HTML to the crawler.](https://developers.google.com/static/search/docs/images/how-dynamic-rendering-works.png)

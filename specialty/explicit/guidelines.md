...
> [!NOTE]
> **Is your site being incorrectly flagged as explicit?**
>
> Check our
>
> [troubleshooting guide](https://developers.google.com/search/docs/specialty/explicit/troubleshooting)
>
...
Regardless of your SafeSearch setting, Google removes pages that violate our [content policies](https://support.google.com/websearch/answer/10622781) (such as child
 sexual abuse material). We also remove pages upon user request for [personal information removal](https://support.google.com/websearch/troubleshooter/3111061) (for example content involving [explicit personal imagery created or shared without consent](https://support.google.com/websearch/answer/6302812),
 or [explicit non-consensual fake content](https://support.google.com/websearch/answer/9116649)).
...
- **Explicit personal information removals** : We demote all pages from sites that receive a
 significant volume of personal removals of content involving [explicit personal imagery created or shared without consent](https://support.google.com/websearch/answer/6302812) or [explicit non-consensual fake content](https://support.google.com/websearch/answer/9116649) .
...
1. Prevent user-generated harmful content on your platform .
2. Allow Google to fetch your video content files .
3. Allow Googlebot to crawl without age gate .
4. Group explicit pages in a separate domain or subdomain .
5. Mark specific pages as explicit with metadata .
...
Allowing Googlebot to [fetch your video files](https://developers.google.com/search/docs/appearance/video#allow-fetch) enables Google to understand the video content and reduces the chance of exposing users to
...
If you don't allow Google to fetch your video content files, Google can't run automated
 protections against [egregious violations such as CSAM](https://support.google.com/websearch/answer/10622781#zippy=%2Cchild-sexual-abuse-imagery-or-exploitation-material).
...
>
> [really are from Google](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot)
>
> .
...
If you have content behind an age gate or other access restriction, be sure to allow Googlebot to
 crawl your content without triggering the age gate. You can do this by [verifying Googlebot requests](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot) and
...
To mark a particular page as explicit, add [rating markup](https://developers.google.com/search/docs/crawling-indexing/special-tags#rating) with the `adult` value either as a [`meta` tag](https://developers.google.com/search/docs/crawling-indexing/special-tags#rating) or an HTTP response header.
...
Google also recognizes `<meta name="rating" content="RTA-5042-1996-1400-1577-RTA">` as an equivalent way to identify pages with sexually explicit content. Either tag is fine; it's
...
>  settings page or some other mechanism to tell search engines about
>
> `meta`
>
> tags. If you want to add a
>
> `meta`
>
> tag to your website, search for instructions about modifying the
>
> `<head>`
>
> of
...
If you have a range of videos on your site, including content appropriate for all ages as well as
 sexually explicit or content that contains graphic violence, make use of the [`<video:family_friendly>` tag in your video sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/video-sitemaps#family-friendly). You only need to use this tag (set to `no`) for

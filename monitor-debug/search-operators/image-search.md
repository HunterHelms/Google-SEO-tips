...
Similarly to web search, Google Images supports dedicated search operators, namely `src:` and `imagesize:`. These operators only work on Google Images;
...
```
src:
https://example.com/media/carrot.jpg
```

The operator returns pages from any domain, not just the domain of the URL specified in the
 operator. This may be helpful to learn which images you're hosting on your site are [hotlinked](https://en.wikipedia.org/wiki/Hotlink) by other sites.

...
>  Learn how to fix JavaScript-related problems with our
>
...
>
> [best practices for crawlable links](https://developers.google.com/search/docs/crawling-indexing/links-crawlable#crawlable-links)
>
> .
...
> `200`
>
> HTTP status code are sent to the rendering queue, no matter whether JavaScript is present on the page.
>  If the HTTP status code is non-
>
> `200`
>
> (for example, on error pages with
>
> `404`
>
> status code), rendering might be skipped.
...
// shows the product information on the page
...
> [!WARNING]
> When using JavaScript to inject the
>
> `rel="canonical"`
>
> link tag, make sure that this is the only
>
> `rel="canonical"`
>
> link tag on the page.
>  Incorrect implementations might create multiple
>
> `rel="canonical"`
>
> link tag or change an existing
>
> `rel="canonical"`
>
> link tag.
...
> `rel="canonical"`
>
> link tags may lead to unexpected results.
...
> `noindex`
>
> tag, it may skip rendering and JavaScript
>  execution, which means using JavaScript to change or remove the
>
> robots
>
> `meta`
...
> `noindex`
>
> may not work as expected. If you
>
> *do*
>
> want the page indexed, don't use a
>
> `noindex`
>
> tag in the original page code.

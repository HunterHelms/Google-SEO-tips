...
A drop in organic Search traffic can happen for several reasons, and it may not be straightforward
 ...
 Search Console [Performance report](https://support.google.com/webmasters/answer/7576553) and [Google Trends](https://trends.google.com/) to investigate the
...
Sketches showing traffic drop graphs and their potential causes Large drop from an algorithmic update, site-wide security or spam issue Seasonality Technical issue across your site, changing interests Reporting glitch ¯\_(ツ)_/¯

The following sections cover the main causes you should investigate
 when analyzing a traffic drop. Also make sure to check the Search Console [Data Anomalies page](https://support.google.com/webmasters/answer/6211453) to see if there is anything applicable to your site. The drop might be related to a change in the
...
Google is always improving how it assesses content and updating its search ranking and serving
 algorithms accordingly; [core updates](https://developers.google.com/search/updates/core-updates) and other smaller
...
In cases like this, self-assess your whole website overall (not just individual pages) to make
 sure it's [helpful, reliable and people-first](https://developers.google.com/search/docs/fundamentals/creating-helpful-content).
...
>
> [continue to rank well with our systems](https://developers.google.com/search/updates/core-updates)
>
> .
...
Check the [Crawl stats report](https://search.google.com/search-console/settings/crawl-stats) and [Page indexing report](https://search.google.com/search-console/index) to find if there's a corresponding spike in issues detected, this might help you pinpoint the
 problem.

### Security issues

If your site is affected by a [security threat](https://developers.google.com/search/docs/monitor-debug/security),
...
Google detects practices that violate Google Search spam policies both through
 ...
 If your site doesn't comply with the [Spam policies for Google web search](https://developers.google.com/search/docs/essentials/spam-policies),
...
If both impressions and clicks dropped, check the list of the most common reasons that
 ...
 generating the best [page title](https://developers.google.com/search/docs/appearance/title-link) and [snippet](https://developers.google.com/search/docs/appearance/snippet) that you could, and so users don't
...
Choose the **Date** filter on top of the chart and select **Last 16 months**.
 ...
 you could use the [Search Analytics API](https://developers.google.com/webmaster-tools/search-console-api-original/v3/searchanalytics) or [bulk data exports](https://support.google.com/webmasters/answer/12917675) to pull data and store it in your systems.
...
Choose the **Date** filter on top of the chart, select the **Compare** tab, and then **Compare last 3 months to previous period** or **Compare last 3
 ...
 or search appearances (learn how to create a [comparison filter](https://support.google.com/webmasters/answer/7576553#comparingdata)).
...
Click **Average position** above the chart. In general, you shouldn't focus too much
 ...
 site. However, if you do see a dramatic, persistent drop in position, try [self-assessing your content](https://developers.google.com/search/docs/fundamentals/creating-helpful-content#self-assess) to gauge if it's helpful and reliable.
...
If it's a site-wide issue, check the [Page indexing report](https://search.google.com/search-console/index).
 If the drop only affects a group of pages, use the [URL inspection tool](https://support.google.com/webmasters/answer/9012289) to investigate a few pages.
...
If you want to go the extra mile, you can [use Google Trends](https://developers.google.com/search/docs/monitor-debug/trends-start) to understand whether the drop is a wider trend or if it's just happening for your site. These
 changes can be caused by two main factors:

1. **Changing interests** . If there are major changes in
...
2. **[Seasonality](https://en.wikipedia.org/wiki/Seasonality)** .
 For example, the [rhythm of food website](https://rhythm-of-food.net/) shows that food related queries are very seasonal: people search for diets in January, turkey in

...
Google Search offers several [translation-related features](https://developers.google.com/search/docs/appearance/translated-results) that enable users to access translated content. If you run an ad network and your ads aren't

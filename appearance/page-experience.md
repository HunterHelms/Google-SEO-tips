...
- [Check if a site's
 connection is secure](https://support.google.com/chrome/answer/95617) : Learn how to
 check if your site's connection is secure, as reported by Chrome.
 If the page isn't served over HTTPS, learn how to [secure your site with HTTPS](https://web.dev/articles/enable-https) .
- [Avoid intrusive
 interstitials and dialog](https://developers.google.com/search/docs/appearance/avoid-intrusive-interstitials) : Learn how to avoid interstitials that can make content less accessible.
- [Chrome Lighthouse:](https://developer.chrome.com/docs/lighthouse/overview) This toolset from Chrome can
...
Core Web Vitals are used by our ranking systems.
 ...
 Keep in mind that getting good results in reports like Search Console's [Core Web Vitals report](https://support.google.com/webmasters/answer/9205520) or third-party tools doesn't guarantee that your pages will rank at the top of Google Search results;
